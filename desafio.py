...
def criar_usuario(usuarios):
    ...
    endereco = input("Informe o endereço (Rua, No, Bairro, Cidade/Sigla_Estado): ")
...
def filtrar_usuario(cpf,usuarios):
    usuarios_filrados = [usuario for usuario in usuarios if usuario ["cpf"] == cpf]
    return usuarios_filrados[0] if usuarios_filrados else None
